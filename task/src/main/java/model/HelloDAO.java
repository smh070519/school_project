...
public class HelloDAO {
    ...
    // INSERT 예시
    public void insertRental(String rentalNo, String custNo, String rentalDateStr, String equipCode, String returnDueStr) {
        try {
        	
        	System.out.println("222:"+rentalNo);
            System.out.println("222:"+custNo);
            System.out.println("222:"+rentalDateStr);
            System.out.println("222:"+equipCode);
            System.out.println("222:"+returnDueStr);
            ...
            java.sql.Date rentalDate = java.sql.Date.valueOf(rentalDateStr); // yyyy-MM-dd 형식 필수
            java.sql.Date returnDue = java.sql.Date.valueOf(returnDueStr);
